<?php
    ...
    flux_add_body_class('user user-items');
...
<div class="list-header">
    ...
    <div class="__mdl_user_listing">
    <h1><?php _e('My listings', 'flux'); ?></h1>
    <?php if(osc_count_items() == 0) { ?>
        <p class="empty" ><?php _e('No listings have been added yet', 'flux'); ?></p>
    <?php } else { ?>
        <div class="actions">
