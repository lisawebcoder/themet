<?php
    ...
    function custom_meta_title($data){
        return __('Change e-mail', 'flux');;
    }
    osc_current_web_theme_path('header.php') ;
    $osc_user = osc_user();
?>
<h1 class="__mdl_regu_hd"><?php _e('Change e-mail', 'flux'); ?></h1>
    ...
    <div class="resp-wrapper">
        ...
        <form id="change-email" action="<?php echo osc_base_url(true); ?>" method="post">
            ...
            <div class="control-group">
                <label for="email"><?php _e('Current e-mail', 'flux'); ?></label>
                <div class="controls">
                    <?php echo osc_logged_user_email(); ?>
                </div>
            </div>
            <div class="control-group">
                <label class="control-label" for="new_email"><?php _e('New e-mail', 'flux'); ?> *</label>
                <div class="controls">
...
<script type="text/javascript">
    $(document).ready(function() {
        $('form#change-email').validate({
            ...
            messages: {
                new_email: {
                    required: '<?php echo osc_esc_js(__("Email: this field is required", "flux")); ?>.',
                    email: '<?php echo osc_esc_js(__("Invalid email address", "flux")); ?>.'
                }
            },
