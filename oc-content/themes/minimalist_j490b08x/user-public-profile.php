...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr" lang="<?php echo str_replace('_', '-', osc_current_user_locale()); ?>">
    ...
    <body>
        ...
        <div class="content item user_public_profile">
            <div id="item_head">
                <div class="inner">
                    <h1><?php echo sprintf(__('%s\'s profile', 'minimalist'), osc_user_name()); ?></h1>
                </div>
            </div>
            <div id="main">
                <div id="description">
                    <ul id="user_data">
                        <li><strong><?php _e('Full name', 'minimalist'); ?>:</strong> <?php echo osc_user_name(); ?></li>
                        <li><strong><?php _e('Address', 'minimalist'); ?>:</strong> <?php echo $address; ?></li>
                        <li><strong><?php _e('Location', 'minimalist'); ?>:</strong> <?php echo $location; ?></li>
                        <li><strong><?php _e('Website', 'minimalist'); ?>:</strong> <?php echo osc_user_website(); ?></li>
                        <li><strong><?php _e('User Description', 'minimalist'); ?>:</strong> <?php echo osc_user_info(); ?></li>
                    </ul>
                </div>
                <div id="description" class="latest_ads">
                    <h2><?php _e('Latest listings', 'minimalist'); ?></h2>
