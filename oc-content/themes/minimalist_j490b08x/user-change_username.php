    ...
    <body>
        ...
        <div class="content user_account">
            ...
            <div id="main" class="modify_profile">
                <h2><?php _e('Change your username', 'minimalist'); ?></h2>
                ...
                <form id="change-username" action="<?php echo osc_base_url(true); ?>" method="post">
                    ...
                    <fieldset>
                        <p>
                            <label for="s_username"><?php _e('Username', 'minimalist'); ?></label>
                            <input type="text" name="s_username" id="s_username" value="" />
                        </p>
                        <p>
                            <span class="help-box" ><?php _e('WARNING: Once set, you will not be able to change your username again. Choose wisely.', 'minimalist'); ?></span>
                        </p>
