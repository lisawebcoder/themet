        ...
        <div class="content user_forms">
            <div class="inner">
                ...
                <form action="<?php echo osc_base_url(true); ?>" method="post" >
                    ...
                    <fieldset>
                        <p>
                            <label for="new_email"><?php _e('New password', 'minimalist'); ?></label><br />
                            <input type="password" name="new_password" value="" />
                        </p>
                        <p>
                            <label for="new_email"><?php _e('Repeat new password', 'minimalist'); ?></label><br />
                            <input type="password" name="new_password2" value="" />
                        </p>
                        <button type="submit"><?php _e('Change password', 'minimalist'); ?></button>
                    </fieldset>
                </form>
            </div>
        </div>
