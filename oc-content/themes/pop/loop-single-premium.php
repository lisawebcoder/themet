...
if (osc_premium_is_premium()) {
    ...
    <?php if (osc_images_enabled_at_items()) { ?>
        <?php if (osc_count_premium_resources()) { ?>
            <a class="" href="<?php echo osc_premium_url(); ?>" title="<?php echo osc_esc_html(osc_premium_title()); ?>"><img src="<?php echo osc_resource_original_url(); ?>" title="" alt="<?php echo osc_esc_html(osc_premium_title()); ?>" width="220" ></a>
        <?php } else { ?>
