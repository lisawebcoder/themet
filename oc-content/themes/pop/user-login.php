    ...
    <div class="form-content">
        <form action="<?php echo osc_base_url(true); ?>" method="post" >
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <button type="submit" class="btn-round btn-black"><?php _e("Log in", 'pop');?></button>
                </div>
            </div>
            <div class="control-group actions">
                <a href="<?php echo osc_register_account_url(); ?>"><?php _e("Register for a free account", 'pop'); ?></a>
                <a href="<?php echo osc_recover_user_password_url(); ?>"><?php _e("Forgot password?", 'pop'); ?></a>
            </div>
        </form>
    </div>
</div>
