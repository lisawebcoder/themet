...
?>
    ...
    <?php osc_current_web_theme_path('user_header.php') ; ?>
				...
				<div class="post-title" style="text-align: center">
					<h2 class="txt_color_2"><?php _e('Search subscribed alerts', 'decent_mobile') ; ?></h2>
				</div>
                <div class="profile-article-wrap clearfix">

                    <?php if(osc_count_alerts() == 0) { ?>
                        <h2><?php _e("You don't have any alerts yet", 'decent_mobile'); ?>.</h2>
                    <?php } else { ?>
                        <?php while(osc_has_alerts()) { ?>
                            <div class="userItem" >
                                <div style="text-align: center" class="txt_color_2"><?php _e('Alert', 'decent_mobile'); ?> | <a class="txt_color_2" onclick="javascript:return confirm('<?php echo osc_esc_js(__(' Are you sure?', 'decent_mobile') ); ?>');" href="<?php echo osc_user_unsubscribe_alert_url() ; ?>"><?php _e('Delete this alert', 'decent_mobile') ; ?></a></div>
								<div class="ad_list">
									<div class="myitem">
