<?php
    ...
    function custom_meta_title($data){
        return __('Change password', 'sakela');;
    }
...
<?php osc_current_web_theme_path('user-sidebar.php');?>
  ...
  <div class="col-md-9" id="userchange-email-col"> 
    <h1><?php _e('Change password', 'sakela'); ?></h1>
       ...
       <div class="resp-wrapper">
        ...
        <form action="<?php echo osc_base_url(true); ?>" method="post">
            ...
            <div class="control-group">
                <label class="control-label" for="password"><?php _e('Current password', 'sakela'); ?> *</label>
                <div class="controls">
                    <input type="password" name="password" id="password" value="" autocomplete="off" />
                </div>
            </div>
            <div class="control-group">
                <label class="control-label" for="new_password"><?php _e('New password', 'sakela'); ?> *</label>
                <div class="controls">
                    <input type="password" name="new_password" id="new_password" value="" autocomplete="off" />
                </div>
            </div>
            <div class="control-group">
                <label class="control-label" for="new_password2"><?php _e('Repeat new password', 'sakela'); ?> *</label>
                <div class="controls">
