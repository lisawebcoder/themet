...
<div class="col-sm-4 col-md-3">
 <div id="search-sidebar-subscribe">
    <?php osc_alert_form(); ?>
 </div>   
 <h1 id="search-sidebar-heading"><?php _e('Advance search', 'sakela') ; ?></h1>  
  <div id="sidebar" class="search-sidebar">
   <div class="filters">
     ...
     <form action="<?php echo osc_base_url(true); ?>" method="get">
        ...
        <fieldset>
            <div class="row price-slice">
                <h3><?php _e('Price', 'sakela') ; ?></h3>
                <span><?php _e('Min', 'sakela') ; ?>.</span>
        ...
        <?php } ?>
        <div class="actions">
            <button type="submit" id="action-button"><?php _e('Apply', 'sakela') ; ?></button>
        </div>
    </form>
   </div>
  </div>
    ...
    <fieldset>
        <h3 id="refine-heading"><?php _e('Refine category', 'sakela') ; ?></h3>
        <div class="row" id="refine">
            <?php sakela_sidebar_category_search($category['pk_i_id']); ?>
        </div>
    </fieldset>
</div>  