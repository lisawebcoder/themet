<?php
    ...
    sakela_add_body_class('register');
    osc_enqueue_script('jquery-validate');
    osc_current_web_theme_path('header.php') ;
?>
<div class="row" id="userchange-email-row">
    <div class="col-sm-6 col-sm-offset-3" id="col-form-register">
<div class="form-register">
    <div class="header">
        <h1><?php _e('Register an account for free', 'sakela'); ?></h1>
    </div>
    <div class="resp-wrapper">
        <form name="register" action="<?php echo osc_base_url(true); ?>" method="post" >
            ...
            <div class="control-group">
                <label class="control-label" for="password-2"><?php _e('Repeat password', 'sakela'); ?></label>
                <div class="controls">
                    <?php UserForm::check_password_text(); ?>
                    <p id="password-error" style="display:none;">
                        <?php _e("Passwords don't match", 'sakela'); ?>
                    </p>
                </div>
            </div>
            ...
            <div class="control-group">
                <div class="controls">
                    <button type="submit" class="btn btn-lg btn-warning"><?php _e("Create", 'sakela'); ?></button>
                </div>
            </div>
        </form>
    </div>
