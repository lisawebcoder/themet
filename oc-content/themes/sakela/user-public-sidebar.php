        ...
        <div id="contact" class="widget-box form-container form-vertical">
            <h2><?php _e("Contact", 'sakela'); ?></h2>
                ...
                <form action="<?php echo osc_base_url(true); ?>" method="post" name="contact_form" id="contact_form">
                    ...
                    <div class="control-group">
                        <label class="control-label" for="yourEmail"><?php _e('Your email address', 'sakela'); ?>:</label>
                    ...
                    <div class="control-group">
                        <div class="controls">
                            ...
                            <button type="submit" class="ui-button ui-button-middle ui-button-main"><?php _e("Send", 'sakela');?></button>
                        </div>
                    </div>
                </form>
