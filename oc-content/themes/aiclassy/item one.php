	   ...
	   <div class="row">
		   ...
		   <?php 
				if(osc_get_preference('position@search', 'aiclassy_theme')=='vertical')
					...
					aiclassy_draw_categories_list_3(); 
   ...
   <div class="col-lg-9 content-right">
		...
		<h2><?php echo osc_item_title() . ' ' . osc_item_city(); ?></h2>
          <div class="row">
                    ...
                    <div id="detailCarousel" class="carousel slide">
                      <div class="carousel-inner">
						...
						<div class="<?php if($i==0) { echo 'active'; } ?> item" data-slide-number="<?php echo $i; ?>">
							<img src="<?php echo osc_resource_url(); ?>" class="img-responsive center-block" alt="<?php _e('Image', 'aiclassy'); ?> <?php echo $i+1;?> / <?php echo osc_count_item_resources();?>" title="<?php _e('Image', 'aiclassy'); ?> <?php echo $i+1;?> / <?php echo osc_count_item_resources();?>" />
						</div>
						<?php } ?>
						<?php }else{ ?>
							<div class="active item" data-slide-number="1">
							<img src="<?php echo osc_current_web_theme_url('images/no_image_available.jpg'); ?>" class="img-responsive center-block" alt="No Image" title="No Image" />
						</div>
						<?php } ?>
                      </div>
			...
			<div id="Location"><?php 
				if(function_exists('google_maps_routes') ) google_maps_routes();
				else osc_run_hook('location'); ?>
			</div>
            <div>
