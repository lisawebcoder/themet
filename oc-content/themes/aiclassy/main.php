...
<div class="row content">
	<?php switch($home_page ){ 
		...
		case('banner-category'): 			
			echo '<div class="col-lg-12 content-right">';
			...
			aiclassy_draw_categories_list_panel(); 
			aiclassy_draw_home_layer_display(osc_get_preference('layer_display_2', 'aiclassy_theme'));
			aiclassy_draw_home_layer_display(osc_get_preference('layer_display_3', 'aiclassy_theme')); 
			echo '</div>';
			break;
	} 	 
		...
		<div class="col-lg-3 content-left">
			<div class="row">
				...
				<div class="responsive-area-origen">
					<?php aiclassy_draw_categories_list_4();
