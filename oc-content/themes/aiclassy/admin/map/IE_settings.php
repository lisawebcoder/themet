...
<h2 class="render-title <?php echo (osc_get_preference('footer_link', 'aiclassy') ? '' : 'separate-top'); ?>"><?php _e('Map Options', 'aiclassy'); ?></h2>
...
function countrySelect($id = null,$selected = null){
    ...
    foreach(osc_get_regions('IE') as $region){
